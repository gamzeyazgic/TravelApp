...
class Details extends StatefulWidget {
  ...
  final String info;
  Details(
      {this.rating, this.imgUrl, this.placeName, this.info});
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  FeaturesTile(
                    icon: Icon(Icons.wifi, color: Color(0xff332045)),
                    label: "Free       Wi-Fi",
                  ),
                  FeaturesTile(
                    icon: Icon(Icons.beach_access, color: Color(0xff332045)),
                    label: "Sand Beach",
                  ),
                  FeaturesTile(
                    icon: Icon(Icons.card_travel, color: Color(0xff332045)),
                    label: "First Coastline",
                  ),
                  FeaturesTile(
                    icon: Icon(Icons.local_drink, color: Color(0xff332045)),
